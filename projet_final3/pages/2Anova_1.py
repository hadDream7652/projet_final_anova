...
tab1, tab2, tab3, tab4 = st.tabs(["**Hypothèses**", "**Résultats**", "**Interprétations**", "**Graphique**"])
    ...
    # Onglet 3: Interprétations
                if 'data' in st.session_state and st.session_state.data is not None:
                    with tab3:
                        ...
                        with subtab2:
                            subtab2.write("### Interprétations détaillées (pour l'ANOVA 2)")
                            if st.session_state.facteurs == 2:
                                ...
                                # Convertir les colonnes en type string
                                st.session_state.data[st.session_state.facteur1] = st.session_state.data[st.session_state.facteur1].astype(str)
                                st.session_state.data[st.session_state.facteur2] = st.session_state.data[st.session_state.facteur2].astype(str)

                                # Visualisation des interactions
                                st.write("#### Les profils d’interaction des groupes")
                    ...
                    with tab4:
                        ...
                        if st.session_state.facteurs == 1:
                            ...
                            st.write("Comparaison des groupes deux à deux ")
                            fig, ax = plt.subplots(figsize=(10, 6))
            ...
            st.write("Les hypothèses de l'ANOVA ne sont pas vérifiées donc nous suggerons un test non paramétrique comme celui de **Kruskal-Wallis** .")
